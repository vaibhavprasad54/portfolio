      ...
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2 p-7 sm:p-2">
          ...
          <p className="py-4 text-gray-600 text-sm sm:text-base">
            As a frontend developer having experience of 1+ year, skilled in Javascript, Reactjs, Nextjs, and
            Tailwind, I carry a deep passion for coding and an unwavering
            commitment to creating robust websites and web-apps. I approach each project with
            an eagerness to learn, grow, and refine my skills.
            I also have working knowledge on backend stack such as Node and Express and MongoDB.
            With a desire to create beautiful and fast user interfaces, I keep learning daily and work on new projects, because as we know, ultimately practice is the key.
              I am keen to dive deeper into how the universe works and the world around us in space.
            I also have a Youtube channel where I upload my music covers since last 12 years.
          </p>

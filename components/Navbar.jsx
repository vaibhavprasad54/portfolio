        ...
        <div className={nav ? "md:hidden fixed left-0 top-0 w-full h-screen bg-black/70": ""}>            {/* Overlay shadow on hamburger click */}
            ...
            <div className="py-4 flex flex-col">
                <ul className="uppercase">
                    ...
                    <Link href="/"> <li className="py-3 font-medium text-sm"> About </li> </Link>
                    <Link href="/"> <li className="py-3 font-medium text-sm"> Skills </li> </Link>
                    <Link href="/"> <li className="py-3 font-medium text-sm"> Project </li> </Link>
                    <Link href="/"> <li className="py-3 font-medium text-sm"> Contact </li> </Link>
                </ul>
